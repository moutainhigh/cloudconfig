...
public class SysOperateService {
	...
	public List<Map<String, Object>> selectOperateByUserId(String userId,String  loginUserId) {
		...
		// 查询某一个角色拥有的权限列表
		List<String> operateIdsOfRole = StringUtils.isNotBlank((String)userMap.get("roleId")) ?sysRoleOperateService
				.selectOpereateIdsByRoleId((String)userMap.get("roleId")):new ArrayList<>();
