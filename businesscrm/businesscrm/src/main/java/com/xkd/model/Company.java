...
public class Company implements Serializable {
	...
	private String companyPhaseId;

	private  String createdByMobile;
	private String companyAdviserMobile;
	private String companyDirectorMobile;
	...
	public String getCompanyPhaseId() {
		return companyPhaseId;
	}

	public void setCompanyPhaseId(String companyPhaseId) {
		this.companyPhaseId = companyPhaseId;
	}
	...
	public String getCompanyAdviserMobile() {
		return companyAdviserMobile;
	}

	public void setCompanyAdviserMobile(String companyAdviserMobile) {
		this.companyAdviserMobile = companyAdviserMobile;
	}

	public String getCompanyDirectorMobile() {
		return companyDirectorMobile;
	}

	public void setCompanyDirectorMobile(String companyDirectorMobile) {
