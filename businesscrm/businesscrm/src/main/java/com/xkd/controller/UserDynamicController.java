...
//            solrService.updateCompanyIndex(groupId);
    ...
    @ResponseBody
    @RequestMapping(value = "/uploadDynamicPicture", method = {RequestMethod.POST})
    @ApiOperation(value = "上传动态图片")
    public ResponseDbCenter uploadDynamicPicture(@RequestParam(value = "files", required = false) MultipartFile[] files,
        ...
        String uploadPath = PropertiesUtil.FILE_UPLOAD_PATH + "dynamic";
        String httpPath = PropertiesUtil.FILE_HTTP_PATH + "dynamic";
