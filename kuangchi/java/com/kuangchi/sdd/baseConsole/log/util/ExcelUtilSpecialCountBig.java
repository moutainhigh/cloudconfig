package com.kuangchi.sdd.baseConsole.log.util;
 ...
 * @创建人　: chudan.guo
 * @创建时间: 2017-01-03 
 * @功能描述:导出几十万数据级别的excel功能util
 * @参数描述:
 */
public class ExcelUtilSpecialCountBig {
    private static final int MAX_NUM = 1048575;
     /**
      * columnsTitles为列标题, 和columnsKeys该列中数据所对应的键, 依次对应
     **/
    public static SXSSFWorkbook exportExcel(String sheetName, String[] columnsTitles,String[] columnsKeys, List<Map<String, Object>> data) throws Exception {
