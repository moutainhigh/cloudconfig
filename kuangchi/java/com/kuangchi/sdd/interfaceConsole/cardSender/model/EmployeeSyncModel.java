...
public class EmployeeSyncModel {
	...
	private String staff_address; // 员工地址
	private String papers_type;// 证件编号
	private String papers_num;// 证件号码
	private String staff_mobile; // 员工手机号码
	private String staff_phone;// 固定号码
	private String staff_position;// 员工职位
	private String staff_email;// 员工邮箱
	private String staff_img;// 员工头像
	private String staff_dept;// 所属部门代码(不是部门编号)
	...
	private String remote_staff_id;// 远端C/S 员工ID
	private String staff_hire_state;// 职位状态：0 在职 1 离职
	private String gw_mc;// 岗位名称
	private String gw_dm;// 岗位代码
	private String room_num;// 岗位代码
	...
	public String getRemote_staff_id() {
		return remote_staff_id;
	}

	public void setRemote_staff_id(String remote_staff_id) {
		this.remote_staff_id = remote_staff_id;
	}
