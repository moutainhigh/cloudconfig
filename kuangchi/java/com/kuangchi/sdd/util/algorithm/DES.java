...
public class DES
{
    ...
    public static String decode(String str)
    {
        ...
        for(int i = 0; i < sBytes.length / 16; i++)
        {
            ...
            try {
				res = (new StringBuilder()).append(res).append(new String(result,"utf-8")).toString();
			} catch (UnsupportedEncodingException e) {
				e.printStackTrace();
			}
        }
    ...
    public static String encode(String str)
    {
        ...
        for(int i = 0; i < newLength / 8; i++)
        {
            ...
            try {
				res = (new StringBuilder()).append(res).append(new String(doubleResult,"utf-8")).toString();
			} catch (UnsupportedEncodingException e) {
				e.printStackTrace();
			}
        }
