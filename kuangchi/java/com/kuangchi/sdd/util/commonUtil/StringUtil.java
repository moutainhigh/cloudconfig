...
public class StringUtil {
    ...
    public static String getDateString(Date date) {
        if (date == null)
            return "";
        DateFormat SIMPLE_DATE_FORMATTER = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    public static String getLongDateString(Date date) {
        if (date == null)
            return "";
        DateFormat DATE_FORMATTER = DateFormat.getDateTimeInstance(1, 1);
