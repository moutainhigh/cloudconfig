package com.kuangchi.sdd.attendanceConsole.attend.util;
...
public class ExcelExportTemplate {
	...
	public void createLongTitleRow(List<TitleRowCell> titleRowCells){
        ...
        for(int i=1;i<5;i++){
        	...
        	if(i==1){
        		cell0.setCellValue("说明:1.支持时间格式：2000-01-01 09:00 (年-月-日 时:分)");
        	}else if(i==2){
        		cell0.setCellValue("          2.员工编号（不可超过10字） ");
        	}else if(i==3){
        		cell0.setCellValue("          3.员工名称（不可超过20字） ");
        	} else{  
