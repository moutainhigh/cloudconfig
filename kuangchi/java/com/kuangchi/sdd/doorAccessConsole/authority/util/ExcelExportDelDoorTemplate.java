 ...
 *
 */
public class ExcelExportDelDoorTemplate {
	...
	public ExcelExportDelDoorTemplate() {
	...
	public void createLongTitleRow(List<TitleRowCell> titleRowCells){
        ...
        for(int i=1;i<3;i++){
        	HSSFRow row1 = sheet.createRow(i);
        	 ...
        	 CellRangeAddress region = new CellRangeAddress(i, i, 0, 1); // 参数都是从O开始   
        	...
        	if(i==1){
        		cell0.setCellValue("说明:1.门名称：选中卡数据行查看权限，设备下有关联门的门名称");
        	}else if(i==2){ 
        		cell0.setCellValue("          2.浅绿色标题栏下的项目为必填项");
        	} 
        }
...
/*	private void createLongTitleRowCell(TitleRowCell t,Cell cell){
	...
	private void createSuggest(Cell cell,List<String> sugs){
		...
		CellRangeAddressList  cellRangeAddressList = new CellRangeAddressList(4, 65535, index, index);
...
/*	private void createLongSuggest(Cell cell,List<String> sugs){
	...
	public static void main(String[] args) throws IOException {
		...
		ExcelExportDelDoorTemplate e = new ExcelExportDelDoorTemplate();
