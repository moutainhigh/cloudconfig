 ...
 *
 */
public class ExcelExportDelCardTemplate {
	...
	public ExcelExportDelCardTemplate() {
	...
	public void createLongTitleRow(List<TitleRowCell> titleRowCells){
        ...
        for(int i=1;i<4;i++){
        	HSSFRow row1 = sheet.createRow(i);
        	 ...
        	 CellRangeAddress region = new CellRangeAddress(i, i, 0, 2); // 参数都是从O开始   
        	...
        	if(i==1){
        		cell0.setCellValue("说明:1.卡号：点开页面数据行,请选择卡下绑定了门的卡号");
        	}else if(i==2){
        		cell0.setCellValue("          2.门名称：请选择选中卡号下绑定的门名称，门名称可重复 ");
        	}else if(i==3){ 
	...
	public static void main(String[] args) throws IOException {
		...
		ExcelExportDelCardTemplate e = new ExcelExportDelCardTemplate();
