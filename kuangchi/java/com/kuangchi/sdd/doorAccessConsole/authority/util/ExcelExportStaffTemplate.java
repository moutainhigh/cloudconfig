 ...
 *
 */
public class ExcelExportStaffTemplate {
	...
	public ExcelExportStaffTemplate() {
	...
	public void createLongTitleRow(List<TitleRowCell> titleRowCells){
        ...
        for(int i=1;i<5;i++){
        	...
        	if(i==1){
        		cell0.setCellValue("说明:1.员工工号：请选择有绑定了卡片的员工工号");
        	}else if(i==2){
        		cell0.setCellValue("          2.门名称：点开页面数据行,选中卡数据行查看权限，设备下有关联门的名称，门名称可重复 ");
        	}else if(i==3){ 
        		cell0.setCellValue("          3.有效开始、有效结束时间格式：2000-01-01 01:00 (年-月-日  时-分) (中间一个空格)");
        	} else{
...
/*	private void createLongSuggest(Cell cell,List<String> sugs){
	...
	public static void main(String[] args) throws IOException {
		...
		ExcelExportStaffTemplate e = new ExcelExportStaffTemplate();
