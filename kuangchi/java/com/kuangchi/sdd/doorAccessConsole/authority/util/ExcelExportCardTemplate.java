 ...
 *
 */
public class ExcelExportCardTemplate {
	...
	public ExcelExportCardTemplate() {
	...
	public void createLongTitleRow(List<TitleRowCell> titleRowCells){
        ...
        for(int i=1;i<5;i++){
        	...
        	if(i==1){
        		cell0.setCellValue("说明:1.卡号：点开页面数据行,请选择员工下的卡号");
        	}else if(i==2){
...
/*	private void createLongSuggest(Cell cell,List<String> sugs){
	...
	public static void main(String[] args) throws IOException {
		...
		ExcelExportCardTemplate e = new ExcelExportCardTemplate();
