package com.kuangchi.sdd.consumeConsole.personConsumeReport.model;

public class PersonConsumeReportModel {
	private  Integer   id;           //人员消费报表ID
