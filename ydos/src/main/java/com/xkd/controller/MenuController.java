    ...
    public ResponseDbCenter selectMenuById(HttpServletRequest req, HttpServletResponse rsp ,
        ...
        try {
            ...
            if (StringUtils.isNotBlank(createBy)) {
                ...
                mmap = pcUserService.selectPcUserById(createBy);
            ...
            if (StringUtils.isNotBlank(updateBy)) {
                ...
                mmap = pcUserService.selectPcUserById(updateBy);
...
//    }
        ...
        try {
            ...
            if ("update".equals(flag)) {
                ...
                if (StringUtils.isBlank(parentMenuId)) {
                    ...
                    //因为是编辑，父菜单没有改变，那么menuId不变
                    if (parentMenuId.equals(menuExists.getParentMenuId())) {
                        maxMenuId = menuExists.getMenuId();
                    } else {
                        maxMenuId = menuService.selectMaxMenuIdByParentId(parentMenuId);
                        if (StringUtils.isNotBlank(maxMenuId)) {
                            maxMenuId = new Integer(maxMenuId).intValue() + 1 + "";
                        } else {
                            maxMenuId = parentMenuId + "01";
                        }
                    }
                }
                ...
                if (maxMenuId.equals(parentMenuId)) {
    ...
    public ResponseDbCenter selectMenuByUserId(HttpServletRequest req, HttpServletResponse rsp
        ...
        try {
            ...
            menuTreeNodes = menuService.selectAllMenuByUserId(loginUserId);
