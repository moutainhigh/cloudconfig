...
public class PropertiesUtil {
	...
	public static String YOUDIAN_OLDAPI_URL;
	//激光推送IP
	public static String YOUDIAN_LIGHTPUSH_IP;
	//token加密密钥
	public static String YOUDIAN_LIGHTPUSH_TOKEN;
	...
	static{
		...
		YOUDIAN_OLDAPI_URL = PropertiesUtil.getProperty("config.properties","youdian.oldApi.url").trim();
		YOUDIAN_LIGHTPUSH_IP = PropertiesUtil.getProperty("config.properties","YOUDIAN_LIGHTPUSH_IP").trim();
		YOUDIAN_LIGHTPUSH_TOKEN = PropertiesUtil.getProperty("config.properties","YOUDIAN_LIGHTPUSH_TOKEN").trim();
