...
public class DateUtils {
	 ...
	 * @return
	 */
	public static Date getAddHourseTime(Date date, int hourse) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
...
//		System.out.println(yearsBetween(stringToDate("2012-10-11","yyyy-MM-dd"),new Date()));
		System.out.println(daysBetween(stringToDate("2012-10-11","yyyy-MM-dd"),stringToDate("2015-10-11","yyyy-MM-dd")));
