...
public interface DictionaryMapper {
	...
	void saveBusinessTemplate(Map<String, Object> map);

	void editeBusinessTemplate(@Param("parentId") String parentId,@Param("ttypeName")  String ttypeName);

	void deleteBusinessTemplate(@Param("id") String id,@Param("parentId") String parentId);

	List<Map<String, Object>> getBusinessTemplate(@Param("pcCompanyId")  String pcCompanyId,@Param("depList") List<String> depList);

	List<Map<String,String>> getBusinessTemplateByParentId(@Param("parentId")  String parentId);
}
