...
public class SalesTicket implements Printable{
	...
	private String operatorName="丁丁"; //操作员
	...
	/**
	* 打印方法
	* graphics - 用来绘制页面的上下文，即打印的图形 28.35 
	...
	*/
	...
	//	Font.BOLD 粗体样式常量。
		...
		//设置小票的标题标题  
		g2.drawString("蝌蚪智慧",(float)x+25,(float)y+heigth); 
		...
		*/
		...
		line += heigth; 
		g2.drawString("欢迎参加会议，祝学习愉快",(float)x+15,(float)y+line);  
			switch (pageIndex) {  
			case 0:  
