...
public class ResponseConstants {
	...
	public static final ResponseDbCenter BANK_PROJECTNAME_EXISTS = new ResponseDbCenter("CRM1106", "该课程名称（项目名称）已经存在");
	
	public static final ResponseDbCenter BANK_PROJECTCODE_EXISTS = new ResponseDbCenter("CRM1107", "该项目编号已经存在");
	
	public static final ResponseDbCenter BANK_PROGRAMNAME_EXISTS = new ResponseDbCenter("CRM1108", "该方案名称已经存在");
	
	public static final ResponseDbCenter BANK_PROGRAMCODE_EXISTS = new ResponseDbCenter("CRM1109", "该方案编号已经存在");
	...
	public static final ResponseDbCenter BANK_POINT_NAME_HAS_EXISTS = new ResponseDbCenter("CRM1115", "该网点名称已经存在");

	public static final ResponseDbCenter BANK_PROJECT_POINT_HAS_EXISTS = new ResponseDbCenter("CRM1116", "网点已经存在项目了");
	...
	public static final ResponseDbCenter YICUNZAI = new ResponseDbCenter("CRM1202", "你添加的联系人已存在，请勿重复添加。");
