...
public class UserDataPermissionService {
   ...
   static String lock="lock";
     ...
     * departmentId不为null时,表示查询用户这个部门下有权限的部门
    ...
    public List<String> getDataPermissionDepartmentIdList(String departmentId,String userId){
      ...
      synchronized (lock) {
          List<String> cacheList = dataPermission.get(userId);
          ...
          if (cacheList == null) {
              ...
              dataPermission.put(userId, list);
          }
        ...
        if (StringUtils.isBlank(departmentId)){
            ...
            return  dataPermission.get(userId);
        }else {
            ...
            if ("1".equals(userMap.get("roleId"))){
                ...
                permitedIdList=dataPermission.get(userId);
            }
