...
public class DepartmentController extends BaseController {
	...
	static {
		...
		tableNames.add("dc_meeting");
		tableNames.add("dc_bank_program");
		tableNames.add("dc_wj_exercise");
	}
...
//			}
	...
	public ResponseDbCenter getTreeByPid(HttpServletRequest req,
								   @ApiParam(value = "部门Id",required = false)  @RequestParam(required = false) String id,
										 @ApiParam(value = "",required = true)  @RequestParam(required = true) String token) throws Exception{
