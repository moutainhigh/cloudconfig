...
public class PagerFileController extends BaseController {
	...
	@ResponseBody
	@RequestMapping(method = {RequestMethod.GET, RequestMethod.POST}, value = "/saveCompanyPagerFiles")
	public ResponseDbCenter saveCompanyPagerFiles(@RequestParam(value = "files", required = false) MultipartFile[] files,
												  String token, String pagerFileId, String appFlag, HttpServletRequest req) {
	...
	@ResponseBody
	@RequestMapping(method = {RequestMethod.GET, RequestMethod.POST}, value = "/saveProjectPagerFiles")
	...
	@ResponseBody
	@RequestMapping(method = {RequestMethod.GET, RequestMethod.POST}, value = "/saveTaskPagerFiles")
	...
	@ResponseBody
	@RequestMapping(method = {RequestMethod.GET, RequestMethod.POST}, value = "/saveProgramPagerFiles")
	...
	@ResponseBody
	@RequestMapping(method = {RequestMethod.GET, RequestMethod.POST}, value = "/saveOtherPagerFiles")
	...
	public ResponseDbCenter updateProgramFileName(HttpServletRequest req,
												String token, String pagerFileId, String fileId, String fileName// 要保存的文件夹名称
	) throws Exception {
		try {
	...
	private ResponseDbCenter updateFileName(HttpServletRequest req, String token, String pagerFileId, String fileId, String fileName) {
		Map<String, String> pagerFile = pagerFileService.getPagerFileById(pagerFileId);
		if (null == pagerFile) {
	...
	public ResponseDbCenter getCompanyFileAndPagerFile2(String token, HttpServletRequest req,
	...
	public ResponseDbCenter downloadOtherCompFileZip(HttpServletRequest req, String pagerFileId, String fileId, String token) throws Exception {
		try {
	...
	public ResponseDbCenter getBusinessOpportunityFileAndPagerFile(String token, HttpServletRequest req,
														@RequestParam(required = false) String likeName, // 修改时传的Id
														@RequestParam(required = false) String ttype, // 保存的目录
														@RequestParam(required = false) String deleteFlag,//0可以删除 1不可以删除
														@RequestParam(required = true) String pagerFileId) throws Exception {
	...
	public ResponseDbCenter getCompanyFileAndPagerFile(String token, HttpServletRequest req,
													   @RequestParam(required = false) String likeName, // 修改时传的Id
													   @RequestParam(required = false) String ttype, // 保存的目录
													   @RequestParam(required = false) String deleteFlag,//0可以删除 1不可以删除
													   @RequestParam(required = true) String pagerFileId) throws Exception {
	...
	public ResponseDbCenter getProgramFileAndPagerFile(String token, HttpServletRequest req,
													   @RequestParam(required = false) String likeName, // 修改时传的Id
													   @RequestParam(required = false) String ttype, // 保存的目录
													   @RequestParam(required = false) String deleteFlag,//0可以删除 1不可以删除
													   @RequestParam(required = true) String pagerFileId) throws Exception {
	...
	public ResponseDbCenter getProgramFileAndPagerFile2(String token, HttpServletRequest req,
														@RequestParam(required = false) String likeName, // 修改时传的Id
														@RequestParam(required = false) String ttype, // 保存的目录
														@RequestParam(required = false) String deleteFlag,//0可以删除 1不可以删除
														@RequestParam(required = true) String pagerFileId) throws Exception {
	...
	public ResponseDbCenter getProjectFileAndPagerFile(String token, HttpServletRequest req,
													   @RequestParam(required = false) String likeName, // 修改时传的Id
													   @RequestParam(required = false) String ttype, // 保存的目录
													   @RequestParam(required = false) String deleteFlag,//0可以删除 1不可以删除
													   @RequestParam(required = true) String pagerFileId) throws Exception {
	...
	public ResponseDbCenter getTaskFileAndPagerFile(String token, HttpServletRequest req,
													   @RequestParam(required = false) String likeName, // 修改时传的Id
	...
	public ResponseDbCenter getProjectFileAndPagerFile2(String token, HttpServletRequest req,
														@RequestParam(required = false) String likeName, // 修改时传的Id
														@RequestParam(required = false) String ttype, // 保存的目录
														@RequestParam(required = false) String deleteFlag,//0可以删除 1不可以删除
														@RequestParam(required = true) String pagerFileId) throws Exception {
	...
	public ResponseDbCenter getOtherFileAndPagerFile(String token, HttpServletRequest req,
													 @RequestParam(required = false) String likeName, // 修改时传的Id
	...
	private ResponseDbCenter changePagerFile(HttpServletRequest req, String token, String pagerFileName, String parentId, String id) {
	...
	public ResponseDbCenter changeFolder(HttpServletRequest req,
										 String token, String fileList// 要保存的文件夹名称
	) throws Exception {
		//try {
...
//		}
	...
	public ResponseDbCenter deleteProgramFile(HttpServletRequest req, String fileList, String token) throws Exception {
		try {
	...
	public ResponseDbCenter deleteProjectFile(HttpServletRequest req, String fileList, String token) throws Exception {
		try {
			deleteFile(req,fileList,token);
			ResponseDbCenter responseDbCenter = new ResponseDbCenter();
			responseDbCenter.setResModel("SUCCESS");
	...
	public ResponseDbCenter deleteCompanyFile(HttpServletRequest req, String fileList, String token) throws Exception {
		try {
			deleteFile(req,fileList,token);
			ResponseDbCenter responseDbCenter = new ResponseDbCenter();
			responseDbCenter.setResModel("SUCCESS");
	...
	public ResponseDbCenter deleteBusinessFile(HttpServletRequest req, String fileList, String token) throws Exception {
		try {
			deleteFile(req,fileList,token);
			ResponseDbCenter responseDbCenter = new ResponseDbCenter();
			responseDbCenter.setResModel("SUCCESS");
	...
	public ResponseDbCenter deleteTaskFile(HttpServletRequest req, String fileList, String token) throws Exception {
		try {
			deleteFile(req,fileList,token);
			ResponseDbCenter responseDbCenter = new ResponseDbCenter();
			responseDbCenter.setResModel("SUCCESS");
	...
	public ResponseDbCenter deleteOtherFile(HttpServletRequest req, String fileList, String token) throws Exception {
		try {
			deleteFile(req,fileList,token);
			ResponseDbCenter responseDbCenter = new ResponseDbCenter();
			responseDbCenter.setResModel("SUCCESS");
	...
	private void deleteFile(HttpServletRequest req, String fileList, String token) {
...
//3a444cb7-fee5-48df-8ba9-fff20366c907
	public ResponseDbCenter downloadProjectFileZip(HttpServletRequest req, String pagerFileId, String fileId, String token) throws Exception {
		try {
			if (StringUtils.isBlank(pagerFileId) && StringUtils.isBlank(fileId)) {
				return ResponseConstants.MISSING_PARAMTER;
			}
	...
	public ResponseDbCenter downloadProgramFileZip(HttpServletRequest req, String pagerFileId, String fileId, String token) throws Exception {
		try {
			if (StringUtils.isBlank(pagerFileId) && StringUtils.isBlank(fileId)) {
				return ResponseConstants.MISSING_PARAMTER;
			}
	...
	public ResponseDbCenter downloadBusinessOpportunityFileZipUnderCompany(HttpServletRequest req, String pagerFileId, String fileId, String token) throws Exception {
		try {
			if (StringUtils.isBlank(pagerFileId) && StringUtils.isBlank(fileId)) {
				return ResponseConstants.MISSING_PARAMTER;
			}
...
//3a444cb7-fee5-48df-8ba9-fff20366c907
	public ResponseDbCenter downloadBusinessOpportunityFileZip(HttpServletRequest req, String pagerFileId, String fileId, String token) throws Exception {
		try {
			if (StringUtils.isBlank(pagerFileId) && StringUtils.isBlank(fileId)) {
				return ResponseConstants.MISSING_PARAMTER;
			}
...
//3a444cb7-fee5-48df-8ba9-fff20366c907
	public ResponseDbCenter downloadOtherFileZip(HttpServletRequest req, String pagerFileId, String fileId, String token) throws Exception {
		try {
			if (StringUtils.isBlank(pagerFileId) && StringUtils.isBlank(fileId)) {
				return ResponseConstants.MISSING_PARAMTER;
			}
	...
	public ResponseDbCenter getShareMyPagerFileList(HttpServletRequest req,String token) throws Exception {
		ResponseDbCenter responseDbCenter = new ResponseDbCenter();
		String userId = req.getSession().getAttribute(token).toString();
		Map<String, Object> user = userService.selectUserById(userId);
		String departmentId = user.get("departmentId").toString();
	...
	public ResponseDbCenter setShare(HttpServletRequest req,String token,String pagerFileId,String departmentIds,String userIds,String level,String pagerName) throws Exception {
	...
	public ResponseDbCenter getShareUserAndDepartment(HttpServletRequest req,String token,String pagerFileId,String level) throws Exception {
		if(StringUtils.isBlank(pagerFileId)  || StringUtils.isBlank(level)  ){
			return ResponseConstants.MISSING_PARAMTER;
		}
		ResponseDbCenter responseDbCenter = new ResponseDbCenter();
