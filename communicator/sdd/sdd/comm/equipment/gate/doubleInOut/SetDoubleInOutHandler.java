 ...
 * 设置双向进出
 * */
public class SetDoubleInOutHandler extends BaseHandler<ByteBuf,GateTimeInterface, ReceiveData> {
	public static final Logger LOG = Logger.getLogger(SetDoubleInOutHandler.class);	
	@Override
