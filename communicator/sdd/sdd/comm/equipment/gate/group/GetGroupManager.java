 ...
 * 
 * */
public class GetGroupManager extends Manager{
   
	
	public GetGroupManager(DeviceInfo2 deviceInfo) {
		super(deviceInfo);
	...
	public ByteBuf setDataBuf(SendHeader info) {
		...
		TimeBlock data = info.getData().getTimeBlock();
		sendBuf.writeByte(data.getBlock());
		return sendBuf;
	}
}
