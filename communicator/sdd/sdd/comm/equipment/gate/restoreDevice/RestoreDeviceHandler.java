 ...
 * 
 * */
public class RestoreDeviceHandler extends BaseHandler<ByteBuf,GateRecordInterface, ReceiveData> {
	public static final Logger LOG = Logger.getLogger(RestoreDeviceHandler.class);
	/**
	 * 处理报头
	 * 
	 * @param receiveBuffer
