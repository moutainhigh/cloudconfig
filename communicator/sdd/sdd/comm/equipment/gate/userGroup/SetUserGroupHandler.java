 ...
 * 设置用户时段组
 * */
public class SetUserGroupHandler extends BaseHandler<ByteBuf, GateLimitInterface, ReceiveData> {
	public static final Logger LOG = Logger.getLogger(SetUserGroupHandler.class);
	/**
	 * 处理报头
	 * 
	 * @param receiveBuffer
