...
public class StringUtil {
	...
	/**
	 * 将门禁设备mac地址转换为固定长度（6位）不足补0的格式
	 * 
	 * @author xuewen.deng
	 * @param mac
	 * @return
	 */
	public static String to_MJDevice_Mac(String mac) {
		return leftPading(mac, "0", 6);
	}
	...
	public static String leftPading(String strSrc, String flag, int strSrcLength) {
		...
		/*
		 * if (strSrc != null && curLength > strSrcLength) { strReturn =
		 * strSrc.trim().substring(0, strSrcLength); } else
		 */
